...
c=Canvas(m,width=340,height=420,bg='skyblue')
c.pack()
l1=Label(m,text='Calculator',font=('times',14,'bold'),bg='green')
c.create_window(160,40,window=l1)
l2=Label(m,text='Enter Value1',font=('times',12),bg='pink',width=14)
c.create_window(100,100,window=l2)
l3=Label(m,text='Enter Value2',font=('times',12),bg='pink',width=14)
c.create_window(100,140,window=l3)
l4=Label(m,text='Output',font=('times',12),bg='yellow',width=14)
...
b4=Button(text='%',command=mod,bg='purple',fg='white',font=('times',12,'bold'),width=5)
c.create_window(160,250,window=b4)
b5=Button(text='/',command=div,bg='purple',fg='white',font=('times',12,'bold'),width=5)
...
b8=Button(text='close',command=m.destroy,bg='grey',fg='white',font=('times',12,'bold'),width=5)
c.create_window(160,320,window=b8)
